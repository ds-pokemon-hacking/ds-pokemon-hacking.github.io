...
| Mapping                                        | PDSMS (Pokemon DS Map Studio): Tile-based custom map creation/editing tool<br/> - [Trifindo's current release](https://github.com/Trifindo/Pokemon-DS-Map-Studio)<br/>  - [AdAstra's fork](https://github.com/AdAstra-LD/Pokemon-DS-Map-Studio) (additional QoL features)<br/>  -  [Trifindo's v1.19](https://github.com/Trifindo/Pokemon-DS-Map-Studio/releases/tag/1.19) (working Animation Editor)<br/>|       |
