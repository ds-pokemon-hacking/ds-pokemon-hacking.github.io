...
14. If all frames look good, then it’s time to **pack** the narc! (if you are not sure how to do this, check out this document [HERE](https://docs.google.com/document/d/1nyuRlun9Gm_5lWodBVLZgOwTgU26k8oyfscnPZZSfV8/edit?usp=sharing).)<!-- TODO add how to pack a NARC in ressource -->
