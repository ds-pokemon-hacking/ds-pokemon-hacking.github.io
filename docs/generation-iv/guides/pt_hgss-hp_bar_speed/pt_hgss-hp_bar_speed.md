...
* Platinum:
Since Platinum overlays aren't compressed, you can just use the `ov016.bin` file in the `YourROMName_DSPRE_contents/arm9_overlays/` folder generated by DSPRE. Alternatively you can extract it with **Tinke** by searching `overlay_9_16` and clicking *Extract*.
