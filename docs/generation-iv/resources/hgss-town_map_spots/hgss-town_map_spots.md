# Town Map Spots
These structures are used to describe the Town Map selectable structures in Heart Gold and Soul Silver as they appear baked into Overlay 101.  See [Editing the Town Map](../../guides/hgss-town_map/) for more information.
